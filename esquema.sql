...
CREATE TABLE ADMINISTRADOR (
    ...
    CONSTRAINT FK_ADM FOREIGN KEY (CPF) REFERENCES CARGO(CPF) 
        ON DELETE CASCADE
);
...
CREATE TABLE COLECIONADOR (
    ...
    CONSTRAINT FK_COLECIONADOR FOREIGN KEY (CPF) REFERENCES CARGO(CPF) 
        ON DELETE CASCADE
);
...
CREATE TABLE AVALIACAO (
    ...
    CONSTRAINT FK_AVALIACAO FOREIGN KEY (COLECIONADOR) REFERENCES COLECIONADOR(CPF) 
        ON DELETE CASCADE
);
...
CREATE TABLE ALBUM (
    ...
    CONSTRAINT FK_ALBUM FOREIGN KEY (ADMINISTRATOR) REFERENCES ADMINISTRADOR(CPF) 
        ON DELETE CASCADE
);
...
CREATE TABLE FIGURINHA (
    ...
    CONSTRAINT FK1_FIGURINHA FOREIGN KEY (ALBUM) REFERENCES ALBUM(ISBN) 
        ON DELETE CASCADE,
    CONSTRAINT FK2_FIGURINHA FOREIGN KEY (ADMINISTRADOR) REFERENCES ADMINISTRADOR(CPF) 
        ON DELETE CASCADE
);
...
CREATE TABLE ALBUM_VIRTUAL (
    ...
    CONSTRAINT FK1_ALBUM_VIRTUAL FOREIGN KEY (COLECIONADOR) REFERENCES COLECIONADOR(CPF) 
        ON DELETE CASCADE,
    CONSTRAINT FK2_ALBUM_VIRTUAL FOREIGN KEY (ALBUM) REFERENCES ALBUM(ISBN)
        ON DELETE CASCADE
);
...
CREATE TABLE BANCA (
    ...
    CONSTRAINT FK_BANCA FOREIGN KEY (ADMINISTRADOR) REFERENCES ADMINISTRADOR(CPF)
        ON DELETE CASCADE   
);
...
CREATE TABLE ALBUM_BANCA (
    ...
    CONSTRAINT FK1_ALBUM_BANCA FOREIGN KEY (ALBUM) REFERENCES ALBUM(ISBN),
    CONSTRAINT FK2_ALBUM_BANCA FOREIGN KEY (BANCA) REFERENCES BANCA(CNPJ)
);
